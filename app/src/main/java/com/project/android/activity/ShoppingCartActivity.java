...
import com.project.android.Adapter.ShoppingCartAdapter;
import com.project.android.R;
import com.project.android.Utils.Utils;
...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    private void initControl(){
            ...
            if(Utils.manggiohang.size()==0){
                ...
                adapter = new ShoppingCartAdapter(getApplicationContext(),Utils.manggiohang);
